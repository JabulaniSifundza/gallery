...
export default function ChicagoArt(){
	...
	const getChi = async ()=>{
		const ids = [16564, 23096, 20347, 28067, 109275, 109260, 23968, 229379, 24096, 47149, 229406, 229361, 230609, 64818, 149784, 147634, 181213, 149068, 149069, 235740, 16568, 87088, 35556, 82892, 111060, 28560, 14586, 79349, 27949, 136121, 60812, 16648];
		try{
